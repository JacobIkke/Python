...
switching_frequency = 1200000  # replace with your actual value for switching frequency (fs) in Hertz
...
delta_il = 0.28 # replace with your actual value for inductor current ripple (ΔIL)
duty_cycle = 0.5  # replace with your actual value for duty cycle (D)
inductor_value = 0.000022  # replace with your actual value for inductor value (L) in Henrys
